...
const Project = ({ info }) => {
  const { img, name, git_client, git_server, liveUrl, technology, features } =
    info;
    ...
    <div>
      <div className={"p-6 shadow-2xl hover:bg-gray-900 rounded-md"}>
        <div className="h-[200px] overflow-y-auto">
          <img
            className="rounded-md hover:overscroll-x-auto"
            src={img}
            alt=""
          />
        </div>
        <div className="mt-6">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="flex gap-4">
              <p>
                <a title="Live Link" href={liveUrl} target="_blank">
                  <TiWorld size={30} />
                </a>
              </p>
              <p>
